...
export default function ClassBenefits({
  ...
  const learningItems = [
    {
      number: '01',
      text: 'Como captar pacientes com ética e técnica',
      highlight: 'captar pacientes'
    },
    {
      number: '02',
      text: 'Como cobrar corretamente e se valorizar',
      highlight: 'cobrar corretamente'
    },
    {
      number: '03',
      text: 'Como estruturar um modelo de negócio de atendimentos',
      highlight: 'modelo de negócio'
    },
    {
      number: '04',
      text: 'Como escalar seu faturamento sem abrir mão da sua saúde',
      highlight: 'escalar seu faturamento'
    }
  ];

  // Dados de quem deve participar
  const participantItems = [
    {
      text: 'Enfermeiros(as) que querem independência'
    },
    {
      text: 'Quem está cansado de turnos massacrantes'
    },
    {
      text: 'Quem quer mudar de vida, mesmo sem saber por onde começar'
    },
    {
      text: 'Profissionais que querem respeito, tempo e liberdade'
    }
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
            ...
            <div>
              <div className="inline-flex items-center bg-[#01C38D]/20 rounded-full px-4 py-2 mb-6">
                ...
                <span className="text-[#01C38D] font-medium">Conhecimentos práticos</span>
              </div>
              
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-8">
                O que você vai sair sabendo da aula
              </h2>
